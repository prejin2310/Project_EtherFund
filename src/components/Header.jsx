  ...
  return (
    <header className='flex justify-between items-center p-5 bg-white  shadow-lg fixed top-0 left-0 right-0'>
      ...
      <div className='flex space-x-2 justify-center'>
        {connectedAccount ? (
          <button type='button' className='inline-block px-6 py-2.5 border border-green-600 font-medium text-xs leading-tight uppercase text-green-600 rounded-[7px] shadow-md bg-transparent'>
            USER: {truncate(connectedAccount, 4,4,11)}</button>
